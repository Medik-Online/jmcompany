...
class Admin
{
    ...
    public function rate_the_prime_slider()
    {
        Notices::add_notice( [
            ...
            'message'          => __( '<b>Win Prime Slider Pro Lifetime License</b> by give us an honest review. Please go to <a href="https://wordpress.org/plugins/bdthemes-prime-slider-lite/">Prime Slider</a> WordPress repository and submit your review. We will select one random user from the review page every month. When you complete your review just fill-up <a href="https://bdthemes.com/giveaway-form/">this form</a> to join our giveaway program.', 'bdthemes-prime-slider' ),
        ] );
    }
